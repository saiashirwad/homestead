...
export class WorktreeAlreadyExists extends Schema.TaggedError<WorktreeAlreadyExists>()(
...
export class WorktreeRemovalRefused extends Schema.TaggedError<WorktreeRemovalRefused>()(
...
export class SocketStartupError extends Schema.TaggedError<SocketStartupError>()(
  "SocketStartupError",
  {
    socketPath: Schema.String,
    reason: Schema.String,
...
export class ExternalCommandError extends Schema.TaggedError<ExternalCommandError>()(
